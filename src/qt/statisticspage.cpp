...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " ZURMO" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " ZURMO" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " ZURMO");
    }
