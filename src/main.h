...
public:
    ...
    {
        // xzurmo: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // xzurmo: get transaction coin age
...
public:
    ...
    // xzurmo: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // xzurmo: two types of block: proof-of-work or proof-of-stake
    ...
    // xzurmo: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // xzurmo: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // xzurmo: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // xzurmo: block index flags
    enum  
    {
